...
import com.backend.server.api.admin.dto.AdminOverviewResponse;
...
public class AdminEquipmentController {
    ...
    public ApiResponse<List<AdminOverviewResponse>> getAdminUsers() {
        List<User> adminUsers = adminEquipmentService.getAdminUsers();
        return ApiResponse.success("관리자 목록 조회 성공", adminUsers.stream().map(AdminOverviewResponse::new).collect(Collectors.toList()));
    }
