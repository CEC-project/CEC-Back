...
public class EquipmentController {
    ...
    public ApiResponse<ReturnResponse> createReturnRequest(@RequestBody ReturnRequest request) {
        ReturnResponse response = EquipmentService.createReturnRequest(request);
    ...
    public ApiResponse<ReturnListResponse> createReturnRequests(@RequestBody ReturnListRequset requestList) {
        ReturnListResponse responses = EquipmentService.createReturnRequests(requestList);
