...
//     public ApiResponse<List<Long>> cancelBulkRentalRequests(EquipmentRentalListRequest request) {
//         equipmentService.cancelBulkRentalRequests(request);
//         return ApiResponse.success("다중 요청 취소 성공", null);
//     }
