...
public class AdminEquipmentCategoryService {
    ...
    public AdminEquipmentCategoryResponse createCategory(EquipmentCategory category) {
        EquipmentCategory savedCategory = categoryRepository.save(category);
        return new AdminEquipmentCategoryResponse(savedCategory);
    }

    public AdminEquipmentCategoryResponse updateCategory(Long id, EquipmentCategory updatedCategory) {
