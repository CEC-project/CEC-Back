...
public class EquipmentController {
    ...
    public ApiResponse<ReturnListResponse> createBulkReturnRequests(@RequestBody ReturnListRequset requestList) {
        Long userId = securityUtil.getCurrentUserId();
        ReturnListResponse responses = EquipmentService.createBulkReturnRequests(requestList);
