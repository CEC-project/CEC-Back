...
insert into public.users (birth_date, damage_count, grade, rental_count, report_count, restriction_count, created_at,
                          professor_id, updated_at, user_id, department, email, gender, "group", major, name, nickname,
