...
public class AdminCategoryService {
    ...
    //카테고리 만들기. 이건 어드민만
    @Transactional
    public CommonCategoryResponse createCategory(AdminCategoryCreateRequest request) {
        // 동일 이름의 카테고리가 있는지 확인
    ...
    //카테고리 수정. 이것도 어드민만 됌.
    @Transactional
    public CommonCategoryResponse updateCategory(Long id, AdminCategoryCreateRequest request) {
