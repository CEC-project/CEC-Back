...
import com.backend.server.api.admin.dto.classroom.AdminClassRoomCreateResponse;
...
public class AdminClassRoomController {
    ...
    //강의실 등록
    @PostMapping
    public ApiResponse<AdminClassRoomCreateResponse> createClassRoom(@Valid @RequestBody AdminClassRoomCreateRequest request) {
    ...
    //강의실 업데이트
    @PutMapping("/{id}")
    public ApiResponse<AdminClassRoomCreateResponse> updateClassRoom(@PathVariable Long id, @Valid @RequestBody AdminClassRoomCreateRequest request) {
