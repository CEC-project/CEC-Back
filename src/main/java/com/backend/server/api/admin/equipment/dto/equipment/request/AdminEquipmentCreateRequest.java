...
public class AdminEquipmentCreateRequest {
    ...
    @Schema(description = "장비 분류(카테고리) ID.", example = "1")
    private Long categoryId;

    @Schema(description = "장비 모델 ID.", example = "1")
    private Long modelId;

    @Schema(description = "생성할 장비 개수.", example = "5")
    private Long quantity;

    @Schema(description = "담당 관리자 ID.", example = "10")
    private Long managerId;

    @Schema(description = "장비 설명", example = "최신 맥북 프로 16인치")
    private String description;

    @Schema(description = "대여 제한 학년", example = "3")
